...
-   **Wahldebaten** sind ein spezifischer Teil des politischen Diskurses und haben **Einfluss auf Emotionen, Einstellungen und Handlungen** von Menschen
...
dict_emojis <- readRDS(here("local_data/dict_emotes.rds"))
...
dfm_emojis <- dfm_chats %>% 
  quanteda::dfm_lookup(
    dictionary = dict_emojis)
