...
2.  [Die etwas andere Einführung in {{< iconify devicon rstudio >}}](#r-introduction)
3.  [Anwedung von {{< iconify devicon rstudio >}} am Beispiel](#r-example)
...
-   🗣️ 2. Präsentationsgruppe: Bitte denkt
    ...
    -   an die Zusendung des **Entwurf der Präsentationsfolien** **bis spätestens [nächste Woche Dienstag 12:00!]{.underline}**
...
... When I Started Using {{< iconify devicon rstudio >}}

<br>

## Building best practice

#### Willkommen (zurück) zu {{< iconify devicon rstudio >}}
...
-   Verwendung von **relative, keine absoluten Pfade. Empfehlung: [here](https://here.r-lib.org/) R-Paket**
:::
:::::
...
# Working with {{< iconify devicon rstudio >}} ... {#r-example background-image="img/slide_bg-example.png"}

... in the real world!

**Im Fokus:** [**Hollywood Age Gap**](https://hollywoodagegap.com/) **Project**

[![](https://raw.githubusercontent.com/faucommsci/teaching_materials/refs/heads/main/images/badges/badge-quarto_document.svg)](/exercises/showcase-03.html) [![](https://raw.githubusercontent.com/faucommsci/teaching_materials/refs/heads/main/images/badges/badge-binder_rstudio.svg)](https://mybinder.org/v2/gh/faucommsci/dbd_binder/HEAD?urlpath=rstudio)
