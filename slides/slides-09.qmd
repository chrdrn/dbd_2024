...
1.  [Text as data in R: Topic Modeling](#topic-modeling)
2.  [📋 Hands on working with R](#exercise)
...
-   Das `stm`-Paket [`r glue::glue("v{packageVersion('quanteda')}")`, @roberts2019] bietet zwei integrierte Lösungen, um das optimale **`K`** zu finden:
    -   `searchK()` Funktion
