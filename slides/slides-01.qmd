...
-   Bearbeitung von **vier Assignments** im Rahmen eines **Portfolios**:
    -   Gruppenpräsentation (👥) zu wissenschaftlichen Grundlagen (📚)
    -   Gruppenpräsentation (👥) zu Research Project (📊)
    -   Peer Review (👤)
    -   Projektbericht (👥)
...
-   **alle Texte der Pflichtlektüre** müssen in der Präsentation **berücksichtigt** werden, die Gruppe kann aber **eigene Schwerpunkte setzen** und eigene Quellen hinzufügen
-   vermittelt **theoretische Grundlage** für Research Projects
...
#### Gruppenpräsentation zum (aktullen Stand) des Projekts

-   präsentiert den aktuellen Stand des Projekts, inklusive Vorstellung des theoretischen Hintergrundes, Forschungsfrage Datenaufbereitung, Analyse und ersten Ergebnisse
...
#### Peer Review der Gruppenpräsentationen

-   ausfüllen von Peer-Review-Formularen (Ratingskalen sowie offenen Fragen) für Präsentationen anderer Gruppen

-   lernen, andere Projekte zu bewerten und konstruktives Feedback zu schreiben

-   Gruppen erhalten die Feedback-Formulare und haben dadurch zusätzliches Feedback zum eigenen Projekte, dass für die Präsentation bzw. den Projektbericht verwendet werden kann
...
#### Schriftlicher Bericht zur Anwendung von Methoden und Analysestrategien

-   der Projektbericht ist die **schriftliche Ausarbeitung** des Forschungsprojekts und führt damit die Arbeit aus den Präsentationen und dem (Feedback der) Peer Reviews zusammen
...
#### Informationen zu den Pflicht-Tutorials
...
-   Ausführliche Informationen sowie Links zu den einzelnen Videos (bzw. Playslisten) finden Sie auf der [Kursseite](https://faucommsci.github.io/dbd_2023/computing/computing-instructions_R.html)
...
| Zeitpunkte | Leistung |
|---------------------|---------------------------------------------------|
| Block II (13./20./27.11) | **Gruppenpräsentation zu wissenschaftlichen Grundlagen 📚** |
| bis zum 4.12. | R-Tutorilas absolvieren um Grundlagenwissen für Methodenblock zu haben |
| bis zum 15.01. | Erster vollständiger **Gruppenpräsentation zum Research Project 📊** |
| vom 16.01. bis zum 21.01. | Ausfüllen der Peer-Review-Formulare |
| vom 22.01 bis 29.01/05.02 | Einarbeitung des Feedback in die **Gruppenpräsentation zum Research Project 📊** |
| 29.01./05.02 | **Gruppenpräsentation zum Research Project 📊** |
| bis zum 02.03.25 | Abgabe des Projektberichts |

<!-- FIXME Fragen-Folien ergänzen -->

# Themenverteilung {#topics background-image="img/slide_bg-participation.png"}

## Wichtige Informatione

#### Sonderanmeldetermin am 28./29.10
...
-   Konsequenz: Nutzung des WiSo-Sonderanmeldetermins am 28./29.10.
...
::: {.column width="50%"}
{{< qrcode https://simpleassign.net/poll/-O9lSn9X3pAIOdHyNQNu >}}
:::
:::::
...
# Any (further) questions? {background-image="img/slide_bg-question.png"}
