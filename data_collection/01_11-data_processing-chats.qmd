...
chat <- list(
    raw = list(
        presidential = qs::qread(here(project_dir, "local_data/chat_raw-vods_presidential_debate.qs")),
        vice_presidential = qs::qread(here(project_dir, "local_data/chat_raw-vods_vice_presidential_debate.qs"))
    )
)
```
...
qs::qsave(
    chat,
    file = here(project_dir, "local_data/chat-debates_full.qs")
)

qs::qsave(
    chat$correct, 
    file = here(project_dir, "local_data/chat-debates.qs")
)
```